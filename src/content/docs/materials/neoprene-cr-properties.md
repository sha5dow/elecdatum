---
title: "Neopreno CR propiedades"
sidebar:
  label: "Neopreno CR"
description: "Ficha tecnica: Neopreno CR propiedades"
keywords: ["neoprene chloroprene rubber properties", "materials"]
category: "materials"
topic: "polymers"
...
La dureza Shore A del neopreno destinado a trajes de buceo se sitúa entre 30 y 50. Las formulaciones comerciales de uso general, vulcanizadas, presentan un rango de dureza de 30 a 90 Shore A según la carga de refuerzo.
...
## Propiedades físicas
La densidad del neopreno sólido es de 1.23 g/cm³ (77 lb/ft³). La espuma de célula cerrada, empleada en trajes de buceo, tiene una densidad comprendida entre 0.1 g/cm³ y 0.3 g/cm³ (6‑19 lb/ft³).
...
La temperatura de servicio continuo del neopreno se extiende desde –40 °C hasta 115 °C (–40 °F a 239 °F). La transición vítrea (Tg) se produce alrededor de –43 °C (–45 °F).
...
El neopreno resiste bien el ozono, la intemperie, los aceites minerales moderados, los fluidos de frenos, el agua de mar y los ácidos diluidos. No es adecuado para contactos prolongados con hidrocarburos aromáticos, ésteres, cetonas o ácidos nítrico y crómico concentrados.
...
El neopreno se utiliza en sectores que requieren resistencia al aceite moderado, a la intemperie y flexibilidad a baja temperatura.
...
| Elastómero | Resistencia al aceite | Resistencia al ozono | Rango de temperatura | Coste relativo |
| --- | --- | --- | --- | --- |
