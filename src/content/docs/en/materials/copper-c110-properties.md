---
title: "Copper C110 properties"
sidebar:
  label: "Copper C110"
description: "Technical reference: Copper C110 properties"
...
Alloy C110 (UNS C11000) has a minimum copper content of 99.9%, with silver counted as copper.
...
The mechanical properties of C110 copper vary significantly between annealed and cold-worked condition, with a tensile strength of up to 400 MPa in hard condition.
...
## Physical properties
The density of C110 copper in solid state is 8.9 g/cm³ (0.323 lb/in³).
...
## Thermal properties
The thermal conductivity of C110 reaches approximately 391 W/m·K at room temperature, making it suitable for heat exchangers.
...
The minimum required electrical conductivity for C110 is 100% IACS, although most commercial supplies exceed 101% IACS.
...
Annealing temperatures for C110 range between 400 and 700 °C, with rapid cooling to maintain ductility.
...
C110 copper is used in more than 30 industrial sectors; among them, electrical engineering, electronics, and construction stand out.
...
Compared to OFE copper (C10100, 99.99% Cu), C110 offers a minimum conductivity of 100% IACS, while OFE reaches a guaranteed 101% IACS and higher chemical purity.
...
C11000 has more than 10 standard equivalents worldwide, including Cu-ETP according to EN 1652.
...
In annealed condition, the elongation in 50 mm ranges between 25% and 30%.

### What is the maximum Rockwell F hardness reached in hard condition?
Cold-worked C110 copper can reach a Rockwell F hardness of up to 100 HRF.

### At what temperature does this material melt?
The melting point of C110 copper is approximately 1083 °C (1981 °F).

### What minimum copper content does the specification guarantee?
The specification requires a minimum copper content (including silver) of 99.90%.
