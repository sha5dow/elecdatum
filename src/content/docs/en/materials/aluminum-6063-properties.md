---
title: "Aluminum 6063 properties"
sidebar:
  label: "Aluminum 6063"
description: "Technical reference: Aluminum 6063 properties"
keywords: ["6063 aluminium alloy properties specifications", "materials"]
category: "materials"
...
The nominal chemical composition of aluminum 6063 according to EN 573-3 and AA standards is detailed in the following table (percentages by mass). Aluminum (Al) constitutes the remainder.
...
The mechanical properties of aluminum 6063 depend on the temper (heat treatment state) and product geometry. The following tables list representative minimum values for extrusions according to BS EN 755-2, unless otherwise indicated.
...
Aluminum 6063 is used when good surface finish, high corrosion resistance, and excellent extrudability are required. Below it is compared with alloys of the same series in temper T6.
