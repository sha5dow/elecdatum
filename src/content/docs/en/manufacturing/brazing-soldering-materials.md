---
title: "Brazing and soldering materials temperatures"
sidebar:
  label: "Brazing and soldering materials temperatures"
description: "Technical reference: Brazing and soldering materials temperatures"
keywords: ["brazing soldering alloys temperatures flux", "manufacturing"]
...
The base metals most commonly joined by soldering and brazing include:
...
Selection of the filler material is based on:

1. **Service temperature of the joint**: select a filler whose melting point is at least 50 °C / 90 °F above the maximum working temperature.
2. **Metallurgical compatibility**: avoid the formation of brittle phases; for example, do not use fillers with cadmium on stainless steels at high temperatures.
3. **Type of heating**: the method (torch, furnace, induction) determines the required melting range and fluidity.
4. **Mechanical and corrosion requirements**: joints for marine environments benefit from fillers with silver or tin‑silver.
5. **Joint clearance**: alloys with a wide melting range (pasty) tolerate larger clearances.
6. **Applicable regulations**: for plumbing, food, or gas applications, lead‑free fillers must be used.
...
**Soldering**: the filler material is melted with a soldering iron, gas torch, or by immersion at temperatures below 450 °C / 842 °F. The most common fluxes are based on rosin (electronics) or zinc chloride (plumbing). Wetting occurs by capillary action if the clearance is appropriate and the surfaces are clean.
